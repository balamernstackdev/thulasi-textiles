...
import { getCoupon } from '@/lib/actions/coupon';
...
export default async function EditCouponPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    const { data: coupon } = await getCoupon(id);
    ...
    return (
        <div className="space-y-8">
            <div className="flex items-center gap-6">
                ...
                <div>
                    <h1 className="text-2xl md:text-3xl font-black text-gray-900 uppercase italic tracking-tighter">Edit Campaign</h1>
                    <p className="text-xs md:text-sm text-gray-500 mt-1 uppercase tracking-widest font-bold">Update your promotional discount code</p>
                </div>
            </div>
